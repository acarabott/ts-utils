...
export function downsampleChannels(channels: Float32Array[], renderWidth: number): IBufferRenderData {
...
export function downsampleRenderData(input: IBufferRenderData, renderWidth: number): IBufferRenderData {
