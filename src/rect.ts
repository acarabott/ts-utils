...
export const Rect = {
  ...
  overlapsRect: (rectA: IRect, rectB: IRect) =>
    rectA.x < Rect.r(rectB) &&
    Rect.r(rectA) > rectB.x &&
    rectA.y < Rect.b(rectB) &&
    Rect.b(rectA) > rectB.y,
  ...
  containsRect: (rect: IRect, point: IPoint) =>
    Rect.containsPoint(rect, point) && Rect.containsPoint(rect, point),
